...
function setup_level_single_area_a() {
	...
	spawner.addPhase([
        ...
        setup_spawn(obj_zombie_elite, 2)
	])
	
	//8
	spawner.addPhase([
		setup_spawn(obj_zombie, 4),
        setup_spawn(obj_zombie_elite, 4)
	])
	...
	//10
	spawner.addPhase([
		setup_spawn(obj_slime_green, 8, 16)
	])
	...
	spawner.addPhase([
		...
		setup_spawn(obj_skeleton_warrior, 10),
	])
	
	//15
	spawner.addPhase([
		setup_spawn(obj_zombie_elite, 12),
	])
	
	//16
	spawner.addPhase([
		setup_spawn(obj_bugbear, 2)
	])
