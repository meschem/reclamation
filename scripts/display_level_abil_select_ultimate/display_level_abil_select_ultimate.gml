...
///@return {bool}
function display_level_abil_select_ultimate(player = noone) {
	if (player == noone) {
	...
	abilities = array_shuffle(obj_ability_controller.availableUltimateAbilities) // get_abilities_for_select(player)
