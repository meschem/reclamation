...
storedBaddies = []          // Used when reloading the room
storedInstances = []        // Used when reloading the room
unlockedWaypoints = []      // List of strings of found waypoints
